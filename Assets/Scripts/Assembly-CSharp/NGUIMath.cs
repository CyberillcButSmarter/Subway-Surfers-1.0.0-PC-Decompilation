...
public static class NGUIMath
{
	...
	public static Vector3 ApplyHalfPixelOffset(Vector3 pos)
	{
		...
		if (platform == RuntimePlatform.WindowsPlayer || platform == RuntimePlatform.OSXPlayer || platform == RuntimePlatform.WindowsEditor || platform == RuntimePlatform.OSXEditor)
		{
			pos.x -= 0.5f;
			pos.y += 0.5f;
		}
